...
const styles = StyleSheet.create({
  ...
  projectHero: { backgroundColor: '#10233f', borderRadius: 24, borderWidth: 1, borderColor: 'rgba(255,255,255,0.18)', paddingHorizontal: 18, paddingVertical: 16, marginBottom: 14, shadowColor: '#0f172a', shadowOpacity: 0.12, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 4 },
  ...
  tileWrap: { padding: 6 },
  tile: { minHeight: 100, backgroundColor: 'rgba(255,255,255,0.92)', borderRadius: 20, borderWidth: 1, borderColor: 'rgba(191,219,254,0.85)', padding: 14, justifyContent: 'space-between', shadowColor: '#0f172a', shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 2 },
