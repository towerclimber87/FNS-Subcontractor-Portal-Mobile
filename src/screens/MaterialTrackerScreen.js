...
const styles = StyleSheet.create({
  ...
  cardActionButton: { borderRadius: 11, paddingHorizontal: 10, paddingVertical: 6, backgroundColor: 'rgba(255,255,255,0.08)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  cardActionText: { color: '#dfe7ff', fontWeight: '900', fontSize: 12 },

  cardBodyRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: -1 },
  qtySummaryBlock: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', gap: 6, alignContent: 'flex-start', paddingTop: 0 },
  ...
  receiveEditorBlock: { width: 118, borderRadius: 15, padding: 8, backgroundColor: 'rgba(75,92,240,0.18)', borderWidth: 1, borderColor: 'rgba(122,162,255,0.35)' },
  receiveLabelRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 6, marginBottom: 4 },
  ...
  receiveInput: { minHeight: 40, borderRadius: 11, paddingHorizontal: 10, paddingVertical: 4, color: '#ffffff', fontSize: 24, fontWeight: '900', textAlign: 'center', backgroundColor: 'rgba(7,17,31,0.68)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)' },
