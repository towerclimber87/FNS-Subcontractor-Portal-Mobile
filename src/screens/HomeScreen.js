...
export default function HomeScreen({ session, onLogout, onOpenProject }) {
  ...
  const content = useMemo(() => {
    ...
    return (
      ...
      >
        <View style={[styles.heroGradient, isPhone && styles.heroGradientPhone]}>
          ...
          <View style={styles.heroAccentRow}>
            <View style={styles.heroAccentOrange} />
...
const styles = StyleSheet.create({
  ...
  heroGradient: { backgroundColor: '#f59e0b', borderRadius: 24, padding: 1.5, marginBottom: 14, shadowColor: '#0f172a', shadowOpacity: 0.14, shadowRadius: 18, shadowOffset: { width: 0, height: 10 }, elevation: 4 },
  heroGradientPhone: { borderRadius: 20, marginBottom: 12 },
  hero: { flexDirection: 'row', alignItems: 'center', gap: 13, backgroundColor: '#10233f', borderRadius: 22, paddingHorizontal: 15, paddingVertical: 15 },
  heroPhone: { gap: 10, borderRadius: 18, paddingHorizontal: 12, paddingVertical: 12 },
  heroAccentRow: { flexDirection: 'row', gap: 6, paddingHorizontal: 14, paddingTop: 7, paddingBottom: 8 },
  heroAccentOrange: { flex: 1.2, height: 4, borderRadius: 999, backgroundColor: '#f97316' },
  heroAccentBlue: { flex: 1, height: 4, borderRadius: 999, backgroundColor: '#38bdf8' },
  heroAccentGreen: { flex: 0.8, height: 4, borderRadius: 999, backgroundColor: '#22c55e' },
  ...
  avatarPhone: { width: 42, height: 42, borderRadius: 15 },
  ...
  heroTitlePhone: { fontSize: 17, lineHeight: 21 },
  ...
  countPillPhone: { minWidth: 38, height: 38, borderRadius: 14 },
  countText: { color: colors.green, fontWeight: '900', fontSize: 18 },
  countTextPhone: { fontSize: 15 },
  ...
  innerProjectCard: { minHeight: 108, backgroundColor: '#fff', borderRadius: 20, borderWidth: 1, borderColor: colors.line, padding: 14, justifyContent: 'space-between', borderLeftWidth: 5, borderLeftColor: '#f59e0b', shadowColor: '#0f172a', shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 2 },
  projectTopRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  projectIcon: { width: 38, height: 38, borderRadius: 14, backgroundColor: '#fff7ed', borderWidth: 1, borderColor: '#fed7aa', alignItems: 'center', justifyContent: 'center' },
